...
export default function TrecholderTaxToNBRPage() {
  ...
  return (
    <ProtectedPage
      userRole={userRole}
      allowedRoles={["TRECHOLDER", "ADMIN"]}
      fallbackMessage="Only TRECHolder and Admin users can access tax to NBR records"
    >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              View, create, and manage your tax to NBR records.
            </p>
          </div>
