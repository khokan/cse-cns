...
> {
    ...
    search() : this {
        ...
        // doctorSearchableFields = ['user.name', 'user.email', 'specialities.speciality.title' , 'specialities.speciality.description']
    ...
    // /doctors?searchTerm=john&page=1&sortBy=name&speciality=cardiology&appointmentFee[lt]=100 => {}
    ...
    filter() : this {
        ...
        Object.keys(filterParams).forEach((key) => {
            ...
            // doctorFilterableFields = ['specialities.speciality.title', 'appointmentFee']
